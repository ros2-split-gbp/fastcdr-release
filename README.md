## fastcdr (rolling) - 1.0.27-1

The packages in the `fastcdr` repository were released into the `rolling` distro by running `/usr/local/bin/bloom-release -r rolling fastcdr` on `Wed, 22 Mar 2023 13:47:13 -0000`
...
- rosdistro version: `1.0.26-1`
- old version: `1.0.26-3`
- new version: `1.0.27-1`
...
## fastcdr (rolling) - 1.0.26-1

The packages in the `fastcdr` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --track rolling --rosdistro rolling fastcdr` on `Fri, 24 Feb 2023 18:02:18 -0000`
...
## fastcdr (humble) - 1.0.24-2

The packages in the `fastcdr` repository were released into the `humble` distro by running `/home/steven/osrf/bloom/.direnv/python-3.10.4/bin/bloom-release -r humble fastcdr` on `Wed, 20 Apr 2022 17:09:59 -0000`
...
- old version: `1.0.24-1`
- new version: `1.0.24-2`
...
## fastcdr (humble) - 1.0.24-1

The packages in the `fastcdr` repository were released into the `humble` distro by running `/home/steven/osrf/bloom/.direnv/python-3.10.4/bin/bloom-release -n -r humble fastcdr` on `Wed, 20 Apr 2022 17:04:47 -0000`
...
## fastcdr (rolling) - 1.0.24-2

The packages in the `fastcdr` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --track rolling --rosdistro rolling fastcdr` on `Tue, 29 Mar 2022 14:07:30 -0000`
...
## fastcdr (rolling) - 1.0.24-1

The packages in the `fastcdr` repository were released into the `rolling` distro by running `/home/steven/osrf/bloom/.direnv/python-3.10.2/bin/bloom-release -e -r rolling fastcdr` on `Fri, 18 Mar 2022 16:45:11 -0000`
...
- upstream repository: https://github.com/eProsima/Fast-CDR.git
- release repository: https://github.com/ros2-gbp/fastcdr-release.git
- rosdistro version: `1.0.20-3`
- old version: `1.0.20-3`
- new version: `1.0.24-1`
...
## fastcdr (rolling) - 1.0.20-2

The packages in the `fastcdr` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --track rolling --rosdistro rolling fastcdr --edit` on `Wed, 24 Mar 2021 15:31:18 -0000`
...
## fastcdr (rolling) - 1.0.20-1

The packages in the `fastcdr` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --track rolling --rosdistro rolling fastcdr --edit` on `Tue, 23 Mar 2021 20:15:33 -0000`
